...
let dataPlanesBase = [
  ...
  { name: "Retail Entel 69.90", price: "69.9" },
  ...
  { name: "Retail Entel 99.90", price: "99.9" },
  ...
  { name: "Retail Power 99.90", price: "99.9" },
  { name: "Retail Power 129.90", price: "129.89" },
  ...
  // { name: "Entel Power 69.90", price: "69.9" },
  ...
  { name: "Entel power familiar 55.90", price: "55.9" },
  { name: "Entel power familiar 37.90", price: "37.9" },
  { name: "Entel power familiar 48.90", price: "48.9" },
  { name: "Entel power familiar 59.90", price: "59.9" },
  { name: "Entel power familiar 74.90", price: "74.9" },
  { name: "Entel power familiar 94.90", price: "94.9" },
  { name: "Entel power Familiar 109.90", price: "109.9" },
  { name: "Entel power familiar 84.90", price: "84.9" },
    ...
    let btnGenerateReceiptFunction = (event) => {
      ...
      btnPdfConvert.addEventListener("click", (e) => {
        ...
        let opt = {
          ...
          enableLinks: false,
          html2canvas: { windowWidth: 100, backgroundColo: "#ffffff" },
          jsPDF: {
            orientation: "p",
            unit: "mm",
            format: "a4",
