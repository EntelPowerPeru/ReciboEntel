  ...
  generateReceipt() {
    ...
    let btnGenerateReceiptFunction = (event) => {
      ...
      for (let w = 0, l = parseInt(valNumnewlines.value); w < l; w++) {
        ...
        let lineasNuevasUnified = `<div id="new_line_description_item${w}" class="recibo_new_line_description_item" style="position: relative;" data-plan="${planHogarSeleccionadoPrice}">
              ...
              ${!Number(cantidadLineasBase) && w == 0 ? "" : formularioDsctoExclusivo}
            </div>`;
      ...
      for (let w = 0, l = parseInt(valNumbaselines.value); w < l; w++) {
        ...
        let lineasBaseUnified = `<div id="new_line_description_item${w}" class="recibo_new_line_description_item" style="position: relative;" data-plan="${planHogarSeleccionadoPrice}">
              ...
              ${w === 0 || Number(cantidadLineasNuevas) === 0 ? "" : formularioDsctoExclusivo}
            </div>`;
    ...
    let btnGenerateReceiptFunctionNuevo = (event) => {
      ...
      for (let w = 0, l = parseInt(valNumnewlines.value); w < l; w++) {
        ...
        let lineasNuevasUnified = `<div id="new_line_description_item${w}" class="recibo_new_line_description_item" style="position: relative;" data-plan="${planHogarSeleccionadoPrice}" data-dscto_beneficio_linea_adicional="${dsctoPrimerRecibo}">
              <div class="descripcion-plan descripcion-plan-precio bg-DCECF4">
                <p class="e-tc--blue">Línea Nueva ${alphabet[
                  alphabetCounter
                ].toUpperCase()}</p>
      ...
      for (let w = 0, l = parseInt(valNumbaselines.value); w < l; w++) {
        ...
        let lineasBaseUnified = `<div id="new_line_description_item${w}" class="recibo_new_line_description_item" style="position: relative;" data-plan="${planHogarSeleccionadoPrice}" data-dscto_beneficio_linea_adicional="${dsctoPrimerRecibo}">
              <div class="descripcion-plan descripcion-plan-precio bg-DCECF4">
                <p class="e-tc--blue">Línea Base ${alphabet[
                  alphabetCounter
                ].toUpperCase()}</p>
