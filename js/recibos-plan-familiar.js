let dataPlanesFamiliares = [
  ...
  { name: "Power 39.90", price: "39.90", es_nuevo: true },
  { name: "Power 49.90", price: "49.90", es_nuevo: true },
  { name: "Power 59.90", price: "59.90", es_nuevo: true },
  { name: "Power Ilim 69.90", price: "69.90", es_nuevo: true },
  { name: "Power Ilim 79.90 SD", price: "79.90", es_nuevo: true },
  { name: "Power Ilim 99.90 SD", price: "99.90", es_nuevo: true },
  { name: "Power Ilim 129.90 SD", price: "129.90", es_nuevo: true },
  { name: "Entel Chip 199.90", price: "199.90", es_nuevo: true },
  { name: "Entel Power 44.90 C", price: "44.90", es_nuevo: true },
  { name: "Entel Power 54.90 C", price: "54.90", es_nuevo: true },
  { name: "Entel Power 69.90 C", price: "69.90", es_nuevo: true },
  { name: "Entel Power 79.90 SD C", price: "79.90", es_nuevo: true },
  { name: "Entel Power 99.90 SD C", price: "99.90", es_nuevo: true },
  { name: "Entel Power 129.90 SD C", price: "129.90", es_nuevo: true },
  { name: "Entel Power Familiar 39.90 C", price: "39.90", es_nuevo: true },
  { name: "Entel Power Familiar 49.90 C", price: "49.90", es_nuevo: true },
  { name: "Entel Power Familiar 59.90 C", price: "59.90", es_nuevo: true },
  { name: "Entel Power Familiar 63.90 C", price: "63.90", es_nuevo: true },
  { name: "Entel Power Familiar 74.90 C", price: "74.90", es_nuevo: true },
  { name: "Entel Power Familiar 89.90 SD C", price: "89.90", es_nuevo: true },
  { name: "Entel Power Familiar 94.90 SD C", price: "94.90", es_nuevo: true },
  { name: "Entel Power Familiar 104.90 SD C", price: "104.90", es_nuevo: true },
  { name: "Entel Power Familiar 199.90", price: "199.90", es_nuevo: true },
];
let dataMesCambio = [
...
let dataPlanesBase = [
  ...
  { name: "Power Ilim 69.90", price: "69.9" },
  ...
  { name: "Entel Power Familiar+ 79.90", price: "79.9" },
  { name: "Power Ilim 79.90 SD", price: "79.9" },
  ...
  { name: "Power Ilim 99.90 SD", price: "99.9" },
  ...
  { name: "Power Ilim 129.90 SD", price: "129.9" },
...
class RecibosPlanesFamiliares {
  constructor() {
    ...
    $("#recibos-plan-familiar input").prop("disabled", true);
    $("#recibos-plan-familiar select").prop("disabled", true);
    $(this.$buttonReset).prop("disabled", true);
  }
  ...
  generateReceipt() {
    ...
    let btnGenerateReceiptFunction = (event) => {
      ...
      let formularioDsctoExclusivo = `<div class="descripcion-dscto-exclusivo bg-white">
        <div style="border: 1px dashed black; border-radius: 5px; padding: 1rem;">
          <p style="font-size: .8rem; text-align: center; margin: 0;">¿Le corresponde descuento exclusivo?</p>

          <select style="font-size: .8rem; width: 100%; height: 30px !important; margin-top: 1rem;" name="tipo_descuento_exclusivo">
      ...
      for (let w = 0, l = parseInt(valNumnewlines.value); w < l; w++) {
        ...
        let lineasNuevasUnified = `<div id="new_line_description_item${w}" class="recibo_new_line_description_item" style="position: relative;"
          data-total="${parseFloat(parseFloat(planHogarSeleccionadoPrice) + parseFloat(calcularProrrateo)).toFixed(2)}"
          data-plan="${planHogarSeleccionadoPrice}"
          data-prorrateo="${parseFloat(calcularProrrateo).toFixed(2)}"
          data-dia_facturacion="${getDiasMesCambioActual}"
          data-dias_prorrateo="${diferenciaFechaCicloDiaCambio}">
      ...
      for (let w = 0, l = parseInt(valNumbaselines.value); w < l; w++) {
        ...
        let lineasBaseUnified = `<div id="new_line_description_item${w}" class="recibo_new_line_description_item" style="position: relative;"
          data-total="${TotalDsctMiPrimerRecibo(w)}"
          data-plan="${planHogarSeleccionadoPrice}"
          ${tienen_mismo_plan ? "" : `data-prorrateo="${calcularProrrateoPlanFamiliar}"`}
          data-dia_facturacion="${getDiasMesCambioActual}"
          data-dias_prorrateo="${diferenciaFechaCicloDiaCambio}">
              <div class="descripcion-plan descripcion-plan-precio bg-DCECF4">
                ...
                <p class="e-tc--blue">${planHogarSeleccionado}</p>
                <p class="e-tc--blue linea_total">${TotalDsctMiPrimerRecibo(w)}</p>
              </div>
              <div class="descripcion-plan-plan bg-white">
                <p></p>
                <p>Plan</p>
    ...
    let btnGenerateReceiptFunctionNuevo = (event) => {
      ...
      for (let w = 0, l = parseInt(valNumnewlines.value); w < l; w++) {
        ...
        let lineasNuevasUnified = `<div id="new_line_description_item${w}" class="recibo_new_line_description_item" style="position: relative;"
          data-total="${w == 0 ? parseFloat( parseFloat(planHogarSeleccionadoPrice) + parseFloat(calcularProrrateo) ).toFixed(2) : parseFloat( parseFloat(planHogarSeleccionadoPrice) + parseFloat(calcularProrrateo) + parseFloat(dsctoPrimerRecibo) ).toFixed(2)}"
          data-plan="${planHogarSeleccionadoPrice}"
          data-prorrateo="${parseFloat(calcularProrrateo).toFixed(2)}"
          ${!Number(cantidadLineasBase) && w == 0 ? "" : `data-dscto_beneficio_linea_adicional="${dsctoPrimerRecibo}`}"
          ${!Number(cantidadLineasBase) && w == 0 ? "" : `data-dscto_prorrateo_beneficio_linea_adicional="${(dsctoPlanFamiliar / (sumaLineas - 1)).toFixed(2)}`}"
          data-dia_facturacion="${getDiasMesCambioActual}"
          data-dias_prorrateo="${diferenciaFechaCicloDiaCambio}">
              <div class="descripcion-plan descripcion-plan-precio bg-DCECF4">
                <p class="e-tc--blue">Línea Nueva ${alphabet[
              ...
              ${!Number(cantidadLineasBase) && w == 0 ? "" : dsctoPrimerReciboHtml + dsctoPrimerRecibo2Html}
              ${formularioDsctoExclusivo}
            </div>`;
        containerReceiptGenerated.insertAdjacentHTML(
          "beforeend",
      ...
      for (let w = 0, l = parseInt(valNumbaselines.value); w < l; w++) {
        ...
        let lineasBaseUnified = `<div id="new_line_description_item${w}" class="recibo_new_line_description_item" style="position: relative;"
          data-total="${valNumnewlines.value == 0 ? TotalDsctMiPrimerRecibo(w) : totalDsctMiPrimerRecibo}"
          data-plan="${planHogarSeleccionadoPrice}"
          ${w === 0 || Number(cantidadLineasNuevas) === 0 ? "" : `data-dscto_beneficio_linea_adicional="${dsctoPrimerRecibo}"`}
          ${w === 0 || Number(cantidadLineasNuevas) === 0 ? "" : `data-dscto_prorrateo_beneficio_linea_adicional="${(dsctoPlanFamiliar / (sumaLineas - 1)).toFixed(2)}"`}
          data-dia_facturacion="${getDiasMesCambioActual}"
          data-dias_prorrateo="${diferenciaFechaCicloDiaCambio}">
              <div class="descripcion-plan descripcion-plan-precio bg-DCECF4">
                <p class="e-tc--blue">Línea Base ${alphabet[
              ...
              ${w === 0 || Number(cantidadLineasNuevas) === 0 ? "" : dsctoPrimerReciboHtml + dsctoPrimerRecibo2Html}
              ${formularioDsctoExclusivo}
            </div>`;
    ...
    $("body").on("change", "[name=tipo_descuento_exclusivo]", (evento) => {
      const total = $(evento.currentTarget).closest(".recibo_new_line_description_item").data("total") || 0;
      const dia_facturacion = $(evento.currentTarget).closest(".recibo_new_line_description_item").data("dia_facturacion") || 0;
      const dias_prorrateo = $(evento.currentTarget).closest(".recibo_new_line_description_item").data("dias_prorrateo") || 0;
      ...
      const plan_monto = $(evento.currentTarget).closest(".recibo_new_line_description_item").data("plan") || 0;
      const prorrateo_monto = $(evento.currentTarget).closest(".recibo_new_line_description_item").data("prorrateo") || 0;
      const dscto_beneficio_linea_adicional_monto = $(evento.currentTarget).closest(".recibo_new_line_description_item").data("dscto_beneficio_linea_adicional") || 0;
      const dscto_prorrateo_beneficio_linea_adicional_monto = $(evento.currentTarget).closest(".recibo_new_line_description_item").data("dscto_prorrateo_beneficio_linea_adicional") || 0;
      const descuento_exclusivo_monto = (-1 * (Number(plan_monto) + Number(dscto_beneficio_linea_adicional_monto)) ) * (Number(tipo_descuento_exclusivo)/100);
      const cargo_prorrateo_descuento_exclusivo_monto = (descuento_exclusivo_monto * dias_prorrateo) / dia_facturacion;
      const linea_total = Number(plan_monto) + Number(prorrateo_monto) + Number(dscto_beneficio_linea_adicional_monto) + Number(dscto_prorrateo_beneficio_linea_adicional_monto) + descuento_exclusivo_monto + cargo_prorrateo_descuento_exclusivo_monto;
      ...
      if(!tipo_descuento_exclusivo) {
        $(evento.currentTarget).closest(".recibo_new_line_description_item").find(".linea_total").html(total);
      ...
      let html_dscto = `<div class="descripcion-plan-dscto-primer-recibo detalle-dscto-exclusivo bg-white">
        ...
        <p>${descuento_exclusivo_monto.toFixed(2)}</p>
      </div>`;
      let html_prorrateo_dscto = `<div class="descripcion-plan-dscto-primer-recibo detalle-dscto-exclusivo bg-white">
        ...
        <p>${cargo_prorrateo_descuento_exclusivo_monto.toFixed(2)}</p>
      </div>`;
      ...
      $(evento.currentTarget).closest(".recibo_new_line_description_item").find(".linea_total").html(linea_total.toFixed(2));
    });

    $("body").on("change", "[name=tienda]", (evento) => {
      ...
      if (!valor) {
        ...
        $("#recibos-plan-familiar input").prop("disabled", false);
        $("#recibos-plan-familiar select").prop("disabled", false);
        $(this.$buttonReset).prop("disabled", false);
      }
    });
  }
...
const EVENTOS = {
  ...
  registrarAccion() {
      $("body").on("click", "#e-button-enviar", async (evento) => {
          const tienda_nombre = $("#tienda option:selected").val();
          const accion_nombre = "generar_recibo";

          const response = await fetch(
              `${VARIABLES.api_url}?accion=registrar_accion`,
              {
                  body: JSON.stringify({
                      tienda_nombre,
                      accion_nombre
